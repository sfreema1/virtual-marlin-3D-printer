...
void get_command()
{
  ...
  while ( Serial.available() > 0  && buflen < BUFSIZE)
  {
    ...
    recieved_char_print(); // Analysis function
    ...
    else
    {
      ...
      if (!comment_mode)
      {
        ...
        Serial.println("Char has been stored in the command buffer.");
      }
      else
      {
...
void recieved_char_print()
{
  if (serial_char == '\n')
  {
    Serial.println("Received char was a newline feed");
  }
  else if (serial_char == '\r')
  {
    Serial.println("Received char was a carriage return");
  }
  else if (serial_char == ' ')
  {
    Serial.println("Received char was a space");
  }
  else
  {
    Serial.print("Received char was a ");
